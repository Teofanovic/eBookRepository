package com.sf13.uros.eBookRepository.lucene.indexing;
...
import com.sf13.uros.eBookRepository.lucene.indexing.analysers.SerbianAnalyzer;
import com.sf13.uros.eBookRepository.lucene.indexing.handlers.DocumentHandler;
import com.sf13.uros.eBookRepository.lucene.indexing.handlers.PDFHandler;
...
public class Indexer {
	...
	/**
	 * @param path
	 *            - kanonicka adresa direktorijuma u koji ce biti smesteni indeksi
	 * @param restart
	 *            - <b>true</b> za kreiranje novog indeksa, <b>false</b> za nastavak
	 *            koriscenja vec postojecih indeksa
	 */
	 ...
	 *            koriscenja vec postojecih indeksa
	 *            <p>
	 *            Direktorijum u kojem ce se indeks nalaziti se ucitava iz
	 *            <i>app.properties</i> datoteke
	 */
	...
	/**
	 * Od dobijenih vrednosti se konstruise Term po kojem se vrsi pretraga
	 * dokumenata Dokumenti koji zadovoljavaju uslove pretrage ce biti obrisani
	 * 
	 * @param fieldName
	 *            naziv polja
	 * @param value
